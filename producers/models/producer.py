...
class Producer:
    ...
    def create_topic(self):
        ...
        if self.topic_name in topic_list.topics:
            print(f"Topic {self.topic_name} already exist in client")
            return
        ...
        list_new_topics.append(topic)
        futures = client.create_topics(list_new_topics)
    ...
    def close(self):
        ...
        if self.topic_name is not None:
            self.producer.flush()
            print(f"Producer has been flushed")
            return
